...
//components
	...
	static JTextField[] salaryAddTF = new JTextField[9];//index 0,1,2 are not used.
	...
	{	
		...
		salaryAddLabel.setToolTipText("Salary modifiers for different doctor attributes");
	...
	public static void addStartStaff()
	{
			...
			.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				if (cb.getSelectedItem() == "Doctor")
				{
					...
					startStaffList.get(index).startStaffPanel.add(startStaffList.get(index).shrinkLabel);
					startStaffList.get(index).startStaffPanel.add(startStaffList.get(index).shrinkCB);
					startStaffList.get(index).startStaffPanel.add(startStaffList.get(index).surgeonLabel);
					startStaffList.get(index).startStaffPanel.add(startStaffList.get(index).surgeonCB);
					startStaffList.get(index).startStaffPanel.add(startStaffList.get(index).researcherLabel);
					startStaffList.get(index).startStaffPanel.add(startStaffList.get(index).researcherCB);
					startStaffList.get(index).startStaffPanel.add(startStaffList.get(index).skillLabel);
					startStaffList.get(index).startStaffPanel.add(startStaffList.get(index).skillTF, "wrap");
				...
				else
				{
					...
					startStaffList.get(index).startStaffPanel.remove(startStaffList.get(index).shrinkLabel);
					startStaffList.get(index).startStaffPanel.remove(startStaffList.get(index).shrinkCB);
					startStaffList.get(index).startStaffPanel.remove(startStaffList.get(index).surgeonLabel);
					startStaffList.get(index).startStaffPanel.remove(startStaffList.get(index).surgeonCB);
					startStaffList.get(index).startStaffPanel.remove(startStaffList.get(index).researcherLabel);
					startStaffList.get(index).startStaffPanel.remove(startStaffList.get(index).researcherCB);
					startStaffList.get(index).startStaffPanel.updateUI();
		...
		startStaffList.get(index).startStaffPanel.add(startStaffList.get(index).staffMemberCombo);
		startStaffList.get(index).startStaffPanel.add(startStaffList.get(index).shrinkLabel);
		startStaffList.get(index).startStaffPanel.add(startStaffList.get(index).shrinkCB);
		...
		startStaffList.get(index).startStaffPanel.add(startStaffList.get(index).researcherLabel);
		startStaffList.get(index).startStaffPanel.add(startStaffList.get(index).researcherCB);
		startStaffList.get(index).researcherCB.addItemListener(new ItemListener()
		{
			public void itemStateChanged(ItemEvent e)
			{
				if (e.getStateChange() == ItemEvent.SELECTED)
		...
		startStaffList.get(index).startStaffPanel.add(startStaffList.get(index).skillLabel);
		startStaffList.get(index).skillLabel.setToolTipText("45 gives doctor, 90 gives consultant");
		startStaffList.get(index).startStaffPanel.add(startStaffList.get(index).skillTF, "wrap");
		startStaffList.get(index).skillTF.addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				...
				{
					startStaffList.get(index).skill = Integer.parseInt(Gui.tempValue);
					tf.setText(Gui.tempValue);
				}
			}
		});
	...
	public static void addStaffLevels()
	{
		...
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).monthLabel);
		staffLevelsList.get(index).monthLabel.setToolTipText("In which month the new staff distribution will take effect");
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).monthTF);
		staffLevelsList.get(index).monthTF.addFocusListener(new FocusListener()
		{
			public void focusGained(FocusEvent e)
			{
				JTextField tf = (JTextField) e.getComponent();
			...
			public void focusLost(FocusEvent e)
			{
				...
				{
					staffLevelsList.get(index).month = Integer.parseInt(Gui.tempValue);
					tf.setText(Gui.tempValue);
				}
				...
				for (int i=0; i < staffLevelsList.size(); i++)
				{
					...
					{
						if (staffLevelsList.get(i).month == staffLevelsList.get(ii).month)
						{
							staffLevelsList.get(ii).month = staffLevelsList.get(i).month + 1;
							staffLevelsList.get(ii).monthTF.setText(Integer.toString(staffLevelsList.get(ii).month));
						}
					}
					for (int ii=index; i > ii; ii++)
					{
						if (staffLevelsList.get(i).month == staffLevelsList.get(ii).month)
						{
							staffLevelsList.get(i).month = staffLevelsList.get(ii).month +1;
							staffLevelsList.get(i).monthTF.setText(Integer.toString(staffLevelsList.get(i).month));
						}
					}
				}
		...
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).doctorsLabel);
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).doctorsTF);
		staffLevelsList.get(index).doctorsTF.addFocusListener(new FocusListener()
		{
			public void focusGained(FocusEvent e)
			{
				JTextField tf = (JTextField) e.getComponent();
			...
			public void focusLost(FocusEvent e)
			{
				...
				{
					staffLevelsList.get(index).doctors = Integer.parseInt(Gui.tempValue);
					tf.setText(Gui.tempValue);
				}
			}
			
		});
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).nursesLabel);
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).nursesTF);
		staffLevelsList.get(index).nursesTF.addFocusListener(new FocusListener()
		{
			public void focusGained(FocusEvent e)
			{
				JTextField tf = (JTextField) e.getComponent();
			...
			public void focusLost(FocusEvent e)
			{
				...
				{
					staffLevelsList.get(index).nurses = Integer.parseInt(Gui.tempValue);
					tf.setText(Gui.tempValue);
				}
			}
			
		});
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).handymenLabel);
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).handymenTF);
		staffLevelsList.get(index).handymenTF.addFocusListener(new FocusListener()
		{
			public void focusGained(FocusEvent e)
			{
				JTextField tf = (JTextField) e.getComponent();
			...
			public void focusLost(FocusEvent e)
			{
				...
				{
					staffLevelsList.get(index).handymen = Integer.parseInt(Gui.tempValue);
					tf.setText(Gui.tempValue);
				}
			}
			
		});
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).receptionistsLabel);
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).receptionistsTF, "wrap");
		staffLevelsList.get(index).receptionistsTF.addFocusListener(new FocusListener()
		{
			public void focusGained(FocusEvent e)
			{
				JTextField tf = (JTextField) e.getComponent();
			...
			public void focusLost(FocusEvent e)
			{
				...
				{
					staffLevelsList.get(index).receptionists = Integer.parseInt(Gui.tempValue);
					tf.setText(Gui.tempValue);
				}
			}
		...
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).shrinkRateLabel);
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).shrinkRateTF);
		staffLevelsList.get(index).shrinkRateTF.addFocusListener(new FocusListener()
		{
			public void focusGained(FocusEvent e)
			{
				JTextField tf = (JTextField) e.getComponent();
			...
			public void focusLost(FocusEvent e)
			{
				...
				try
				{
					...
					{
						//remove the "1/" so the value can be saved properly
					...
					{
						staffLevelsList.get(index).shrinkRate = Integer.parseInt(Gui.tempValue.replaceFirst("1/", ""));
						tf.setText(Gui.tempValue);
					}
				}catch (NumberFormatException nfe)
				{
		...
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).surgeonRateLabel);
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).surgeonRateTF);
		staffLevelsList.get(index).surgeonRateTF.addFocusListener(new FocusListener()
		{
			public void focusGained(FocusEvent e)
			{
				JTextField tf = (JTextField) e.getComponent();
			...
			public void focusLost(FocusEvent e)
			{
				...
				try
				{
					...
					else if (input.matches("\\d+"))
					{
						int value = Integer.parseInt(input);
						staffLevelsList.get(index).surgeonRate = value;
						staffLevelsList.get(index).surgeonRateTF.setText("1/"+value);
					}
					else
					{
						staffLevelsList.get(index).surgeonRate = Integer.parseInt(Gui.tempValue.replaceFirst("1/", ""));
						tf.setText(Gui.tempValue);
					}
				}catch (NumberFormatException nfe)
				{
		...
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).researcherRateLabel);
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).researcherRateTF);
		staffLevelsList.get(index).researcherRateTF.addFocusListener(new FocusListener()
		{
			public void focusGained(FocusEvent e)
			{
				JTextField tf = (JTextField) e.getComponent();
			...
			public void focusLost(FocusEvent e)
			{
				...
				try
				{
					...
					else if (input.matches("\\d+"))
					{
						int value = Integer.parseInt(input);
						staffLevelsList.get(index).researcherRate = value;
						staffLevelsList.get(index).researcherRateTF.setText("1/"+value);
					}
					else
					{
						staffLevelsList.get(index).researcherRate = Integer.parseInt(Gui.tempValue.replaceFirst("1/", ""));
						tf.setText(Gui.tempValue);
					}
				}catch (NumberFormatException nfe)
				{
		...
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).consultantRateLabel);
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).consultantRateTF);
		staffLevelsList.get(index).consultantRateTF.addFocusListener(new FocusListener()
		{
			public void focusGained(FocusEvent e)
			{
				JTextField tf = (JTextField) e.getComponent();
			...
			public void focusLost(FocusEvent e)
			{
				...
				try
				{
					...
					else if (input.matches("\\d+"))
					{
						int value = Integer.parseInt(input);
						staffLevelsList.get(index).consultantRate = value;
						staffLevelsList.get(index).consultantRateTF.setText("1/"+value);
					}
					else
					{
						staffLevelsList.get(index).consultantRate = Integer.parseInt(Gui.tempValue.replaceFirst("1/", ""));
						tf.setText(Gui.tempValue);
					}
				}catch (NumberFormatException nfe)
				{
		...
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).juniorRateLabel);
		staffLevelsList.get(index).staffLevelsPanel.add(staffLevelsList.get(index).juniorRateTF, "wrap");
		staffLevelsList.get(index).juniorRateTF.addFocusListener(new FocusListener()
		{
			public void focusGained(FocusEvent e)
			{
				JTextField tf = (JTextField) e.getComponent();
			...
			public void focusLost(FocusEvent e)
			{
				...
				try
				{
					...
					else if (input.matches("\\d+"))
					{
						int value = Integer.parseInt(input);
						staffLevelsList.get(index).juniorRate = value;
						staffLevelsList.get(index).juniorRateTF.setText("1/"+value);
					}
					else
					{
						staffLevelsList.get(index).juniorRate = Integer.parseInt(Gui.tempValue.replaceFirst("1/", ""));
						tf.setText(Gui.tempValue);
					}
				}catch (NumberFormatException nfe)
				{
		...
		if (staffLevelsList.size() > 1)
		{
			...
			int monthPlus = Integer.parseInt(staffLevelsList.get(index -1).monthTF.getText()) +6;
			staffLevelsList.get(index).monthTF.setText(Integer.toString(monthPlus));
		}
		
		//randomize staff distribution
		int randomInt = (new Random().nextInt(5) -2);
		staffLevelsList.get(index).doctors += randomInt;
		staffLevelsList.get(index).doctorsTF.setText(Integer.toString(
				staffLevelsList.get(index).doctors));
		randomInt =  (new Random().nextInt(4) -5);
		staffLevelsList.get(index).nurses += randomInt;
		staffLevelsList.get(index).nursesTF.setText(Integer.toString(
				staffLevelsList.get(index).nurses));
		randomInt =  (new Random().nextInt(3));
		staffLevelsList.get(index).handymen += randomInt;
		staffLevelsList.get(index).handymenTF.setText(Integer.toString(
				staffLevelsList.get(index).handymen));
		randomInt =  (new Random().nextInt(4) -1);
		staffLevelsList.get(index).receptionists += randomInt;
		staffLevelsList.get(index).receptionistsTF.setText(Integer.toString(
				staffLevelsList.get(index).receptionists));
	}
