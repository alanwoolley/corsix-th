...
//components
	...
	JPanel drug = new JPanel(new MigLayout("wrap 5",
			"[]15[]")); // Row gaps
	JPanel psych = new JPanel(new MigLayout("wrap 4",
			"[]15[]")); // Row gaps
	JPanel clinic = new JPanel(new MigLayout("wrap 4",
			"[]15[]")); // Row gaps
	JPanel op = new JPanel(new MigLayout("wrap 4",
			"[]15[]")); // Row gaps
	...
	JLabel multipleTvPersonalitiesLabel = new JLabel("Multiple TV Personalities");
	...
	//drug panel
		...
		expertiseResearchTF[5].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(expertiseResearchTF[5].getText());
					if (input < 1)
					{
						expertiseResearch[5] = 1;
						expertiseResearchTF[5].setText(Integer.toString(expertiseResearch[5]));
					}
					else
		...
		visualsAvailableTF[3].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(visualsAvailableTF[3].getText());
					if (input < 0)
					{
						visualsAvailable[3] = 0;
						visualsAvailableTF[3].setText(Integer.toString(visualsAvailable[3]));
					}
					else
		...
		expertiseResearchTF[11].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(expertiseResearchTF[11].getText());
					if (input < 1)
					{
						expertiseResearch[11] = 1;
						expertiseResearchTF[11].setText(Integer.toString(expertiseResearch[11]));
					}
					else
		...
		visualsAvailableTF[9].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(visualsAvailableTF[9].getText());
					if (input < 0)
					{
						visualsAvailable[9] = 0;
						visualsAvailableTF[9].setText(Integer.toString(visualsAvailable[9]));
					}
					else
		...
		expertiseResearchTF[13].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(expertiseResearchTF[13].getText());
					if (input < 1)
					{
						expertiseResearch[13] = 1;
						expertiseResearchTF[13].setText(Integer.toString(expertiseResearch[13]));
					}
					else
		...
		visualsAvailableTF[11].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(visualsAvailableTF[11].getText());
					if (input < 0)
					{
						visualsAvailable[11] = 0;
						visualsAvailableTF[11].setText(Integer.toString(visualsAvailable[11]));
					}
					else
		...
		expertiseResearchTF[15].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(expertiseResearchTF[15].getText());
					if (input < 1)
					{
						expertiseResearch[15] = 1;
						expertiseResearchTF[15].setText(Integer.toString(expertiseResearch[15]));
					}
					else
		...
		visualsAvailableTF[13].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(visualsAvailableTF[13].getText());
					if (input < 0)
					{
						visualsAvailable[13] = 0;
						visualsAvailableTF[13].setText(Integer.toString(visualsAvailable[13]));
					}
					else
		...
		expertiseResearchTF[16].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(expertiseResearchTF[16].getText());
					if (input < 1)
					{
						expertiseResearch[16] = 1;
						expertiseResearchTF[16].setText(Integer.toString(expertiseResearch[16]));
					}
					else
		...
		expertiseResearchTF[17].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(expertiseResearchTF[17].getText());
					if (input < 1)
					{
						expertiseResearch[17] = 1;
						expertiseResearchTF[17].setText(Integer.toString(expertiseResearch[17]));
					}
					else
		...
		expertiseResearchTF[24].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(expertiseResearchTF[24].getText());
					if (input < 1)
					{
						expertiseResearch[24] = 1;
						expertiseResearchTF[24].setText(Integer.toString(expertiseResearch[24]));
					}
					else
		...
		expertiseResearchTF[25].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(expertiseResearchTF[25].getText());
					if (input < 1)
					{
						expertiseResearch[25] = 1;
						expertiseResearchTF[25].setText(Integer.toString(expertiseResearch[25]));
					}
					else
		...
		expertiseResearchTF[28].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(expertiseResearchTF[28].getText());
					if (input < 1)
					{
						expertiseResearch[28] = 1;
						expertiseResearchTF[28].setText(Integer.toString(expertiseResearch[28]));
					}
					else
		...
		expertiseResearchTF[29].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(expertiseResearchTF[29].getText());
					if (input < 1)
					{
						expertiseResearch[29] = 1;
						expertiseResearchTF[29].setText(Integer.toString(expertiseResearch[29]));
					}
					else
		...
		expertiseResearchTF[32].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(expertiseResearchTF[32].getText());
					if (input < 1)
					{
						expertiseResearch[32] = 1;
						expertiseResearchTF[32].setText(Integer.toString(expertiseResearch[32]));
					}
					else
		...
		expertiseResearchTF[33].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(expertiseResearchTF[33].getText());
					if (input < 1)
					{
						expertiseResearch[33] = 1;
						expertiseResearchTF[33].setText(Integer.toString(expertiseResearch[33]));
					}
					else
	...
	//psych panel
		...
		availableLabel2.setToolTipText("In which month the disease should first appear (not implemented in the game yet?)");
		...
		visualsAvailableTF[2].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(visualsAvailableTF[2].getText());
					if (input < 0)
					{
						visualsAvailable[2] = 0;
						visualsAvailableTF[2].setText(Integer.toString(visualsAvailable[2]));
					}
					else
	...
	//op panel
		...
		availableLabel3.setToolTipText("In which month the disease should first appear (not implemented in the game yet?)");
		...
		visualsAvailableTF[12].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(visualsAvailableTF[12].getText());
					if (input < 0)
					{
						visualsAvailable[12] = 0;
						visualsAvailableTF[12].setText(Integer.toString(visualsAvailable[12]));
					}
					else
	...
	//clinic panel
		...
		availableLabel4.setToolTipText("In which month the disease should first appear (not implemented in the game yet?)");
		...
		visualsAvailableTF[4].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(visualsAvailableTF[4].getText());
					if (input < 0)
					{
						visualsAvailable[4] = 0;
						visualsAvailableTF[4].setText(Integer.toString(visualsAvailable[4]));
					}
					else
		...
		visualsAvailableTF[5].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(visualsAvailableTF[5].getText());
					if (input < 0)
					{
						visualsAvailable[5] = 0;
						visualsAvailableTF[5].setText(Integer.toString(visualsAvailable[5]));
					}
					else
		...
		visualsAvailableTF[6].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(visualsAvailableTF[6].getText());
					if (input < 0)
					{
						visualsAvailable[6] = 0;
						visualsAvailableTF[6].setText(Integer.toString(visualsAvailable[6]));
					}
					else
		...
		visualsAvailableTF[7].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(visualsAvailableTF[7].getText());
					if (input < 0)
					{
						visualsAvailable[7] = 0;
						visualsAvailableTF[7].setText(Integer.toString(visualsAvailable[7]));
					}
					else
		...
		visualsAvailableTF[8].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(visualsAvailableTF[8].getText());
					if (input < 0)
					{
						visualsAvailable[8] = 0;
						visualsAvailableTF[8].setText(Integer.toString(visualsAvailable[8]));
					}
					else
		...
		visualsAvailableTF[10].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(visualsAvailableTF[10].getText());
					if (input < 0)
					{
						visualsAvailable[10] = 0;
						visualsAvailableTF[10].setText(Integer.toString(visualsAvailable[10]));
					}
					else
		...
		visualsAvailableTF[0].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(visualsAvailableTF[0].getText());
					if (input < 0)
					{
						visualsAvailable[0] = 0;
						visualsAvailableTF[0].setText(Integer.toString(visualsAvailable[0]));
					}
					else
		...
		visualsAvailableTF[1].addFocusListener(new FocusListener()
		{
			...
			public void focusLost(FocusEvent e)
			{
				try
				{
					int input = Integer.parseInt(visualsAvailableTF[1].getText());
					if (input < 0)
					{
						visualsAvailable[1] = 0;
						visualsAvailableTF[1].setText(Integer.toString(visualsAvailable[1]));
					}
					else
