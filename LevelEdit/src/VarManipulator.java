...
public class VarManipulator
{
	...
	//TODO: the arguments are weird. they should probably refer to an actual variable, 
	...
	public void setValueForTable(String variable, int index, int value)
	{
		...
		{
			TabDiseases.visualsAvailableTF[index].setText(Integer.toString(value));
			TabDiseases.visualsAvailable[index] = value;
		}
		else if (variable == "expertiseResearch")
		{
			TabDiseases.expertiseResearchTF[index].setText(Integer.toString(value));
			TabDiseases.expertiseResearch[index] = value;
		}
		else if (variable == "objectsStrength")
		{
			TabObjects.objectsStrengthTF[index].setText(Integer.toString(value));
			TabObjects.objectsStrength[index] = value;
		}
		else if (variable == "objectsResearch")
		{
			TabObjects.objectsResearchTF[index].setText(Integer.toString(value));
		...
		else if (variable == "startStaff.doctor")
		{
			if (value == 1)
			{
				...
				TabStaff.startStaffList.get(index-1).staffMemberCombo.setSelectedItem("Doctor");
			}
		}
		else if (variable == "startStaff.nurse")
		{
			if (value == 1)
			{
				...
				TabStaff.startStaffList.get(index-1).staffMemberCombo.setSelectedItem("Nurse");
			}
		}
		else if (variable == "startStaff.handyman")
		{
			if (value == 1)
			{
				...
				TabStaff.startStaffList.get(index-1).staffMemberCombo.setSelectedItem("Handyman");
			}
		}
		else if (variable == "startStaff.receptionist")
		{
			if (value == 1)
			{
				...
				TabStaff.startStaffList.get(index-1).staffMemberCombo.setSelectedItem("Receptionist");
			}
		}
		else if (variable == "startStaff.skill")
		{
			TabStaff.startStaffList.get(index-1).skill = value;
			TabStaff.startStaffList.get(index-1).skillTF.setText(Integer.toString(value));
		}
		else if (variable == "startStaff.shrink")
		{
			...
			{
				//making sure that the staff member is a doctor before adding other qualifications.
				if (value == 1 && TabStaff.startStaffList.get(index-1).doctor == 1)
				{
					TabStaff.startStaffList.get(index-1).shrink = 1;
					TabStaff.startStaffList.get(index-1).shrinkCB.setSelected(true);
				}
				else
				{
					TabStaff.startStaffList.get(index-1).shrink = 0;
					TabStaff.startStaffList.get(index-1).shrinkCB.setSelected(false);
				}
			}
		}
		else if (variable == "startStaff.surgeon")
		{
			...
			if (TabStaff.startStaffList.size() > index-1)
			{
				...
				if (value == 1 && TabStaff.startStaffList.get(index-1).doctor == 1)
				{
					...
					TabStaff.startStaffList.get(index-1).surgeonCB.setSelected(true);
				}
				else
				{
					TabStaff.startStaffList.get(index-1).surgeon = 0;
					TabStaff.startStaffList.get(index-1).surgeonCB.setSelected(false);
				}
			}
		}
		else if (variable == "startStaff.researcher")
		{
			...
			if (TabStaff.startStaffList.size() > index-1)
			{
				...
				if (value == 1)
				{
					...
					TabStaff.startStaffList.get(index-1).researcherCB.setSelected(true);
				}
				else
				{
					TabStaff.startStaffList.get(index-1).researcher = 0;
					TabStaff.startStaffList.get(index-1).researcherCB.setSelected(false);
				}
			}
		}
		...
		else if (variable == "emergencyIntervalVariance")
		{
			...
			TabEmergencies.emergencyIntervalVarianceTF.setText(Integer.toString(value));
		}
		else if (variable == "emergency.startMonth")
		{
			...
			TabEmergencies.emergencyList.get(index).startMonthTF.setText(Integer.toString(value));
		}
		else if (variable == "emergency.endMonth")
		{
			TabEmergencies.emergencyList.get(index).endMonth = value;
			TabEmergencies.emergencyList.get(index).endMonthTF.setText(Integer.toString(value));
		}
		else if (variable == "emergency.minPatients")
		{
			TabEmergencies.emergencyList.get(index).minPatients = value;
			TabEmergencies.emergencyList.get(index).minPatientsTF.setText(Integer.toString(value));
		}
		else if (variable == "emergency.maxPatients")
		{
			TabEmergencies.emergencyList.get(index).maxPatients = value;
			TabEmergencies.emergencyList.get(index).maxPatientsTF.setText(Integer.toString(value));
		}
		...
		else if (variable == "emergency.percWin")
		{
			...
			TabEmergencies.emergencyList.get(index).percWinTF.setText(Integer.toString(value));
		}
		else if (variable == "emergency.bonus")
		{
			TabEmergencies.emergencyList.get(index).bonus = value;
			TabEmergencies.emergencyList.get(index).bonusTF.setText(Integer.toString(value));
		}
		else if (variable == "quake.startMonth")
		{
			...
			TabEarthquakes.quakeList.get(index).startMonthTF.setText(Integer.toString(value));
		}
		else if (variable == "quake.endMonth")
		{
			TabEarthquakes.quakeList.get(index).endMonth = value;
			TabEarthquakes.quakeList.get(index).endMonthTF.setText(Integer.toString(value));
		}
		else if (variable == "quake.severity")
		{
			TabEarthquakes.quakeList.get(index).severity = value;
			TabEarthquakes.quakeList.get(index).severityTF.setText(Integer.toString(value));
		}
		else if (variable == "population.month")
		{
			...
			TabPopulation.populationList.get(index).monthTF.setText(Integer.toString(value));
		}
		else if (variable == "population.change")
		{
			TabPopulation.populationList.get(index).change = value;
			TabPopulation.populationList.get(index).changeTF.setText(Integer.toString(value));
		}
	...
	//same as above with the string arguments.
	public void setCriteria(String variable, boolean exists, int value, int value2)
	{
		...
		else if (variable == "loseCriteria.value")
		{
			...
			if (value == 5)
			{
				...
				TabGoals.minPercentageKilledTF.setText(Integer.toString(value2));
			}
		}
		else if (variable == "loseCriteria.bound")
		{
			...
			if (value == 5 && TabGoals.losePercentageKilled == true)
			{
				...
				TabGoals.warnPercentageKilledTF.setText(Integer.toString(value2));
			}
		}
	...
	public void setDefault()
	{
		...
		TabAwards.cansOfCokeTF.setText(Integer.toString(TabAwards.CANS_OF_COKE));
		TabAwards.cansOfCokeBonus = TabAwards.CANS_OF_COKE_BONUS;
		TabAwards.cansOfCokeBonusTF.setText(Integer.toString(TabAwards.CANS_OF_COKE_BONUS));
		...
		TabAwards.reputationBonusTF.setText(Integer.toString(TabAwards.REPUTATION_BONUS));
		TabAwards.noDeathsBonus = TabAwards.NO_DEATHS_BONUS;
		TabAwards.noDeathsBonusTF.setText(Integer.toString(TabAwards.NO_DEATHS_BONUS));
		...
		setCriteria("loseCriteria.value", false, 5, TabGoals.MIN_PERCENTAGE_KILLED);
		TabGoals.warnReputation = TabGoals.maxReputation + 50;
		TabGoals.warnReputationTF.setText(Integer.toString(TabGoals.warnReputation));
		...
		TabGoals.warnPercentageKilledTF.setText(Integer.toString(TabGoals.warnPercentageKilled));
	...
	//	in the future, it could be called by rightclicking an individual textfield.
...
//			setValue("briefing", BRIEFING);
			...
			setValue("drugStartRating", Integer.toString(TabGeneral.DRUG_START_RATING));
		else if (tf == TabGeneral.drugImproveRateTF)
			setValue("drugImproveRate", Integer.toString(TabGeneral.DRUG_IMPROVE_RATE));
		else if (tf == TabGeneral.drugStartCostTF)
			setValue("drugStartCost", Integer.toString(TabGeneral.DRUG_START_COST));
			...
			setValue("landCostPerTile", Integer.toString(TabGeneral.LAND_COST_PER_TILE));
		else if (tf == TabGeneral.autopsyResearchPercentTF)
			setValue("autopsyResearchPercent", Integer.toString(TabGeneral.AUTOPSY_RESEARCH_PERCENT));
		else if (tf == TabGeneral.autopsyRepHitPercentTF)
			setValue("autopsyRepHitPercent", Integer.toString(TabGeneral.AUTOPSY_REPHIT_PERCENT));
		else if (tf == TabGeneral.researchUpgradeCostTF)
			setValue("researchUpgradeCost", Integer.toString(TabGeneral.RESEARCH_UPGRADE_COST));
		else if (tf == TabGeneral.researchUpgradeIncrementCostTF)
			setValue("researchUpgradeIncrementCost", Integer.toString(TabGeneral.RESEARCH_UPGRADE_INCREMENT_COST));
		else if (tf == TabGeneral.strengthIncrementTF)
			setValue("strengthIncrement", Integer.toString(TabGeneral.STRENGTH_INCREMENT));
	...
	public void setDefaultCB(JCheckBox cb)
	{
		...
		for (int i=0; i<TabObjects.objectsAvail.length; i++)
		{
			...
			{
				if (i==9|i==13|i==14|i==22|i==23|i==24|i==25|i==26|i==27
						|i==30|i==37|i==40|i==41|i==42|i==46|i==47|i==54|i==57)
				{
